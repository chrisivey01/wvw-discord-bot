...
module.exports =  {
    dm: async (message, client) => {
        ...
        for await (user of obtainedUser) {
            await delay(500);
            client.users.get(user[1].user.id).send("New bot activated! You dont have to register if you dont want too. \n \n" +
                "Apologies for the DM I made a booboo... Register to the new WvW Discord Bot to track your kill progress! \n " +
                "!api #######-####-####-####-####################-####-####-####-############ \n" +
                ...
                "Got ideas for new content? Or wanting to donate to show some love, no donation is too small! - please visit -> http://wvw-community.com/");
